...
class PaleoRA(cmd.Cmd):
    ...
    def do_sendfile(self, arg):
        ...
        self.current_file = client.files.create(
        ...
        thread_message = client.beta.threads.messages.create(
            thread_id=self.thread.id,
            role="user",
            content="This is the pdf file of a research paper I’ll be studying today. you’re an research assistant in paleontology to answer my questions. Please refer this paper as Author(s) (Year) format.",
            file_ids=[self.current_file.id]
        )
